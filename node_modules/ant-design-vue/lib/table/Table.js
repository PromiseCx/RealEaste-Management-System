  ...
  methods: {
    ...
    recursiveSort: function recursiveSort(data, sorterFn) {
      ...
      return data.sort(sorterFn).map(function (item) {
        return item[childrenColumnName] ? (0, _extends5['default'])({}, item, (0, _defineProperty3['default'])({}, childrenColumnName, _this8.recursiveSort(item[childrenColumnName], sorterFn))) : item;
      });
    },
